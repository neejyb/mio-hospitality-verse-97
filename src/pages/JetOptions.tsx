                ...
                >
                  <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 group h-full flex flex-col">
                    ...
                    <CardContent className="p-4 flex-grow flex flex-col">
                      ...
                      <p className="text-[#D4AF37] font-semibold mb-2">${jet.price}/hour</p>
                          ...
                          <div className="flex-1 overflow-y-auto p-6 pt-0">
                            <div className="space-y-4">
                              ...
                              <div className="flex justify-between items-center">
                                <span className="text-2xl font-bold text-[#D4AF37]">${jet.price}/hour</span>
                                <span className="bg-gray-100 px-3 py-1 rounded-full text-sm font-medium">{jet.category}</span>
                              </div>
