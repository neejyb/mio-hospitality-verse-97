...
const serviceData: Record<string, ServiceInfo> = {
  'interior-design': {
    ...
    description: [
      'At Mio\'s Hospitality & Co, we believe that interior design is about more than just aesthetics – it\'s about creating spaces that reflect your personality, meet your functional needs, and enhance your quality of life.',
      'Our team of experienced designers works closely with you to understand your vision, lifestyle, and preferences. Whether you\'re looking to refresh a single room or transform an entire property, we deliver tailored solutions that exceed expectations.'
    ],
    ...
    detailImages: [
      ...
      'https://images.unsplash.com/photo-1567016432779-094069958ea5?q=80&w=2080'
    ],
    features: [
  ...
  'airbnb': {
    ...
    description: [
      'Our Airbnb Services division provides comprehensive management and optimization for property owners looking to maximize their investment returns through short-term rentals.',
      'For guests, we offer a curated selection of exceptional properties that combine luxury amenities with the comfort and authenticity of a home away from home. Each property in our portfolio is personally vetted and maintained to our exacting standards.'
    ],
    ...
    features: [
      'Professional property styling and staging',
      ...
      'Regular performance reporting for property owners'
    ],
    process: [
      {
  ...
  'videography': {
    ...
    description: [
      'Our professional videography services capture the essence and unique features of your property or event with cinematic quality and artistic direction.',
      'Whether you need compelling footage for marketing your Airbnb property, documenting a special event, or creating promotional content for your business, our videography team delivers polished, engaging visual stories that resonate with your target audience.'
    ],
    coverImage: 'https://images.unsplash.com/photo-1679430764089-e9197afaa4e5?q=80&w=2070',
    detailImages: [
      'https://images.unsplash.com/photo-1576836165612-8bc9b07e7778?q=80&w=2074',
      'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?q=80&w=2071',
      'https://images.unsplash.com/photo-1472457897821-70d3819a0e24?q=80&w=2069'
    ],
    features: [
      ...
      'Distribution-ready formats for all platforms'
    ],
    process: [
      {
  ...
  'car-hire': {
    ...
    description: [
      'Our Car Hire service offers an exceptional fleet of luxury and performance vehicles for your transportation needs. From chauffeur-driven elegance to self-drive thrills, we provide premium automotive experiences that complement your lifestyle.',
      'Each vehicle in our collection is maintained to the highest standards of performance and cleanliness, ensuring a memorable and comfortable experience every time you drive with us.'
    ],
    ...
    features: [
      'Diverse fleet of luxury and performance vehicles',
  ...
  'jet-hire': {
    ...
    description: [
      'Experience the pinnacle of luxury travel with our Private Jet Charter service. We provide access to exceptional aircraft for business or leisure travel, offering unparalleled comfort, privacy, and convenience.',
      'Our jet charter service eliminates the hassles of commercial travel, allowing you to fly on your schedule to destinations worldwide. Whether for business efficiency or leisure luxury, our private aviation solutions are tailored to exceed your expectations.'
    ],
    coverImage: 'https://images.unsplash.com/photo-1540962351504-03099e0a754b?q=80&w=2070',
    detailImages: [
      'https://images.unsplash.com/photo-1540962351504-03099e0a754b?q=80&w=2070',
      'https://images.unsplash.com/photo-1566472546919-37e4ddb08e9a?q=80&w=2097',
      'https://images.unsplash.com/photo-1551651059-87c7348dcc65?q=80&w=2070'
    ],
    features: [
      'Access to premium private jets',
      'Flexible scheduling',
      'Direct flights to thousands of airports worldwide',
      'Luxurious cabin amenities',
      'Personalized catering options',
      'Ground transportation coordination',
      'Dedicated flight attendants for larger aircraft'
    ],
    process: [
      {
  ...
  'maintenance': {
    ...
    description: [
      'Our Maintenance Services division provides reliable, high-quality property care and repairs for residential and commercial properties. We handle everything from routine maintenance to emergency repairs with promptness and professionalism.',
      'With a team of skilled technicians and contractors, we ensure your property remains in optimal condition while minimizing disruption to occupants. Our preventative maintenance programs help avoid costly repairs and extend the life of your property\'s systems and structures.'
    ],
  ...
  'property-management': {
    ...
    description: [
      'Our comprehensive Property Management services handle all aspects of property ownership, allowing you to enjoy the benefits of your investment without the day-to-day responsibilities.',
      'From tenant acquisition and management to financial oversight and maintenance coordination, our experienced property managers serve as your trusted partners in maximizing returns while preserving and enhancing your property\'s value.'
    ],
    ...
    detailImages: [
      ...
      'https://images.unsplash.com/photo-1577173632711-e8c0fbe8f3e9?q=80&w=2046',
      'https://images.unsplash.com/photo-1582407947304-fd86f028f716?q=80&w=2596'
    ],
    features: [
  ...
  'facility-support': {
    ...
    description: [
      'Our Facility Support Services provide comprehensive solutions for commercial properties, ensuring smooth operations and optimal functionality of your business environment.',
      'From cleaning and security to equipment maintenance and space management, our team of specialists delivers reliable, efficient services that allow you to focus on your core business activities while maintaining a professional, productive facility.'
    ],
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero section */}
        <div className="relative h-[50vh] bg-cover bg-center flex items-center" style={{ backgroundImage: `url(${service.coverImage})` }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <Link to={service.cta.link}>
                  <Button className="mt-6 bg-mio-orange hover:bg-mio-red text-white transition-colors">
                    {service.cta.text}
                  </Button>
                </Link>
              </motion.div>
              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  {service.detailImages.map((image, index) => (
                    <div 
                      key={index}
              ...
              {service.process.map((step, index) => (
                ...
                >
                  ...
                  {index < service.process.length - 1 && (
                    <div className="absolute top-6 left-1/2 w-full h-0.5 bg-gray-200 -z-10 hidden lg:block"></div>
                  )}
        ...
        {/* CTA section */}
        <section className="py-16 bg-mio-darkred text-white">
