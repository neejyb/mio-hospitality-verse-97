...
const TransportSection = () => {
  return <section className="py-16 bg-gradient-to-b from-gray-900 to-gray-800 text-white bg-red-950">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          once: true
            ...
            <img src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?q=80&w=2070" alt="Luxury Car Rental" className="w-full h-[400px] object-cover group-hover:scale-105 transition-transform duration-500" />
            <div className="absolute inset-0 z-20 flex flex-col justify-end p-6">
              ...
              <Link to="/services/car-hire" className="inline-block">
                <button className="text-white font-semibold py-2 px-6 rounded-md transition-colors duration-300 inline-flex items-center bg-red-950 hover:bg-red-800">
                  Explore Cars
          ...
          once: true
            ...
            <div className="absolute inset-0 bg-black/50 group-hover:bg-black/40 transition-colors z-10"></div>
            <img src="https://images.unsplash.com/photo-1540962351504-03099e0a754b?q=80&w=2070" alt="Private Jet Charter" className="w-full h-[400px] object-cover group-hover:scale-105 transition-transform duration-500" />
            <div className="absolute inset-0 z-20 flex flex-col justify-end p-6">
